...
describe("Product API Testing", () => {
  ...
  // Menggunakan fungsi fetchProductsData(1) untuk mengambil data produk dengan ID 1 dari API atau sumber data produk.
  // Menggunakan asinkron async/await karena fetchProductsData kemungkinan bersifat asinkron (bergantung pada implementasi internalnya).
  // Menggunakan expect untuk memeriksa apakah nilai ID pada objek productData 
  // sesuai dengan yang diharapkan (1) dan judul produk sesuai dengan yang diharapkan ("iPhone 9").
  ...
  // test case ini mengevaluasi apakah fungsi fetchProductsData dan 
  // setProductsCards berinteraksi dengan benar dan apakah panjang array kartu produk 
  // sesuai dengan batas yang diharapkan.
  ...
  // Berfungsi mendefinisikan variabel price dan discountPercentage untuk merepresentasikan harga produk dan persentase diskon.
  // Memanggil fungsi countDiscount dengan menggunakan nilai price dan discountPercentage.
  // Menggunakan expect untuk memeriksa apakah hasil dari perhitungan diskon (discountedPrice) sesuai dengan nilai yang diharapkan (90).
